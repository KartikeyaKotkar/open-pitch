...
// ─── Expose as globals for content-script usage ───────────────────────────────
// (Content scripts cannot use ES module imports, so we attach to window/globalThis)

if (typeof globalThis !== 'undefined') {
  globalThis.SoundTouch = SoundTouch;
  globalThis.SimpleFilter = SimpleFilter;
  globalThis.FifoSampleBuffer = FifoSampleBuffer;
  globalThis.RateTransposer = RateTransposer;
  globalThis.Stretch = Stretch;
  globalThis.AbstractFifoSamplePipe = AbstractFifoSamplePipe;
}
